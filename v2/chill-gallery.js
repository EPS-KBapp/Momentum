(function () {
  ...
  function render(root) {
    ...
    shell.innerHTML = `
      <article class="panel">
        <h3>Chill natif</h3>
        <p>Ajoute tes envies, choisis une catégorie puis lance une recherche pour sélectionner la pochette parmi plusieurs résultats.</p>
  ...
  function bind(root) {
    if (root.dataset.chillGalleryBound === 'true') return;
    root.dataset.chillGalleryBound = 'true';
